...
class DecwavPool {
    ...
    onProcExited(decwav) {
        // TODO: fix this.  There is severe jankiness (at least on wine) where once a process
        // crashes, the replacement will fail to start until ALL wine processes are killed
